          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {VENTURE_AREAS.map((area, i) => (
              <FadeIn key={i} delay={i * 100} className="h-full">
                <div className="p-8 rounded-3xl bg-white/[0.05] border border-white/5 hover:bg-white/[0.03] transition-all h-full group">
            ...
            <div className="lg:col-span-7 space-y-4">
              {HOW_BUILT.map((item, i) => (
                <FadeIn key={i} delay={i * 150} direction="right">
                  <div className="p-8 rounded-3xl border border-white/5 bg-white/[0.04] flex items-start gap-8 group hover:border-blue-500/30 transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            {OPERATING_MODEL.map((model, i) => (
              <FadeIn key={i} delay={i * 150} direction="up">
                <div className="h-full flex flex-col text-center p-6 lg:p-10 rounded-[3rem] border border-white/5 bg-white/[0.0] hover:border-cyan-500/30 transition-all">
            ...
            <div className="max-w-6xl mx-auto relative rounded-[4rem] overflow-hidden bg-white/5 border border-white/10 p-12 md:p-24 text-center">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <Link href="/connect" className="px-10 py-5 bg-cyan-500 text-black rounded-full font-bold text-lg hover:bg-white transition-all flex items-center justify-center gap-2 group">
                    <Mail size={20} />
                    Get in touch
                    <ArrowUpRight size={18} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                  </Link>
                  <Link  href="/research" className="px-10 py-5 bg-white/5 border border-white/10 text-white rounded-full font-bold text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2">
                    <FileText size={20} />
                    View Research
                  </Link>
                </div>
